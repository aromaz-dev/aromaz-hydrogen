...
export const BLOG_POSTS = [
  {
    ...
    content: [
      ...
      'My second assumption is around how much of these perfumes they use. As mush as its fun to have very strongly scented deodorant that you smell it as strong as a solid perfume but that is yet another reason for skin irritation. You can’t pass a certain percentage of how much essential oil you add , if passed a certain percentage it can easily cause skin irritation. So, a balanced amount of essential oils that make the deodorant smell amazing but also safe for our skin.',
    ],
  },
] satisfies BlogPost[];
