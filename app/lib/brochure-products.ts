export const BROCHURE_PRODUCTS = [
  ...
  },
  {
    ...
    category: 'Lavender Botanical Ritual',
    price: 'Retail CA$12.00',
    description:
      'A bright exfoliating soap story with lavender calm, natural texture, and a fresh spa-like finish.',
    detail:
  ...
  },
  {
    ...
    category: 'Lip Care Collection',
    price: 'Retail CA$5.00',
    description:
      'Refreshing daily lip comfort with a crisp cooling feel and bright clean energy.',
    detail:
      'Quick comfort, light refreshment, and simple natural care that fits every bag, pocket, or checkout display.',
    background: '/brochure/bg-lip-balm-cooling-sunny.png',
    image: '/brochure/lip-balm-cooling.png',
  ...
  },
  {
    ...
    price: 'Retail CA$5.00',
    description:
      'Nourishing lip care with a warm restorative feel and an easy everyday soothing story.',
    detail:
      'The comfort-focused side of the lip balm family, made for soft, dependable everyday care.',
    background: '/brochure/bg-lip-balm-healing-sunny.png',
    image: '/brochure/lip-balm-healing.png',
    href: '/products/refresh-renew-bundle?Ingredient%20origin=Healing%20Lip%20Balm',
  },
] as const;
